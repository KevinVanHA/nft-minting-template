      ...
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://discord.gg/HuwTWcAvYq"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 bg-[#2ecc71] hover:bg-[#27ae60] text-white rounded-full transition-colors duration-200"
            >
            ...
            <a
              href="https://x.com/_OTGOFFICIAL"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 bg-[#1f9650] hover:bg-[#15793e] text-white rounded-full transition-colors duration-200"
            >
              <img
                src="/X_logo_2023.png"
                alt="X (Twitter) logo"
